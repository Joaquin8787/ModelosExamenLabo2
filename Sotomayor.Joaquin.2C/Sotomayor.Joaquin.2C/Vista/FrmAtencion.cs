    ...
    public partial class FrmAtencion : Form
    {
        ...
        private void btnAtender_Click(object sender, EventArgs e)
        {
            ...
            { 
                ...
                lstMedicos.Enabled = true;
                lstPacientes.Enabled = true;
               // MessageBox.Show("Atencion finalizada", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
        ...
        private void lstMedicos_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                rtbInfoMedico.Text = personalMedico.FichaPersona(personalMedico);
